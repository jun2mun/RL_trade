...
if submit4:
  ...
  training_data = load_data_2(symbol,window_size)
...
if submit3: # jun ac2 submit
  model_name = 'test'#symbol
  training_data = load_data_2(symbol,window_size)
  num_features = training_data.shape[1]
  #print(data.shape) # 10578,33
  filtered_data = filter_data_by_date(training_data, start_date, end_date)
  agent = AC2_Agent(state_size = num_features, pretrained = False, model_name = model_name)
  episode_count = 50; batch_size= 32
